...
?>
    ...
    ?>
        <tr>
            ...
            <td>
                <form action=<?php echo "index.php?ira=editaritem&id_item=$id_item";?> method="post">
                ...
                if(count($arr_img) == 0){
                    ...
                    foreach($arr_img as $img){
                        ...
                        echo "<tr><td><img src='$img' class='imagen'/></td>
                                <td><a href='index.php?ira=editaritem&id_item=$id_item&borrar_img=$ruta_img'>[BORRAR]</a></td></tr>";
                    }
                }
            ?>
        </tr>
    ...
    ?>
    <table>
        <form action='<?php echo "index.php?ira=editaritem&id_item=$id_item";?>' method="post" enctype="multipart/form-data">
            <tr>
